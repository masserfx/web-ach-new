...
async def ai_chat(request: AIChatRequest):
    ...
    if any(word in message_lower for word in ["cena", "kolik", "stojí", "price"]):
        ...
        Všechny ceny jsou individuální dle projektu. Mohu vám pomoci s nezávaznou kalkulací?
        """
        ...
        ✅ Modernizační fond: až 50% nákladů (BD, firmy)
        ...
        Přesnou kalkulaci vám připravím pomocí naší kalkulačky. Chcete si to vyzkoušet?
        """
        suggested_actions = ["Spustit kalkulačku", "Zobrazit reference", "Poslat poptávku"]
        
    else:
        response = """
        Děkuji za váš dotaz. Jsem tu, abych vám pomohl s:
